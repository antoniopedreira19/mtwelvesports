...
const requiredDocuments = [
  {
    ...
    description: "Histórico escolar traduzido e apostilado.",
    icon: GraduationCap,
  ...
  {
    title: "Passaporte",
    description: "Cópia digitalizada do passaporte válido.",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Atestado médico para prática esportiva.",
    icon: Stethoscope,
  ...
  {
    title: "Vídeo de Highlight",
    description: "Vídeo com os melhores momentos esportivos.",
    icon: Camera,
  ...
  },
  {
    ...
    description: "TOEFL, IELTS, Duolingo ou equivalente.",
    icon: FileCheck,
  ...
  },
  {
    ...
    description: "Documentos adicionais solicitados pela assessoria.",
    icon: FilePlus2,
    ...
    <Card className="bg-[#141414] border-white/5 hover:border-[#E8BD27]/20 transition-all duration-300 group hover:shadow-lg hover:shadow-[#E8BD27]/5">
      <CardHeader className="pb-3">
        <div className="flex items-start gap-3">
          <div
            className={`w-10 h-10 rounded-xl bg-gradient-to-br ${doc.color} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300`}
          >
    ...
    <div className="min-h-[80vh] space-y-6 animate-in fade-in duration-500">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-[#141414] border border-white/5 p-1 rounded-xl w-full md:w-auto">
          <TabsTrigger value="home" className="data-[state=active]:bg-[#E8BD27]/15 data-[state=active]:text-[#E8BD27] text-white/50 rounded-lg gap-2 px-4">
            <Home className="w-4 h-4" />
            <span className="hidden sm:inline">Início</span>
          </TabsTrigger>
          <TabsTrigger value="placement" className="data-[state=active]:bg-[#E8BD27]/15 data-[state=active]:text-[#E8BD27] text-white/50 rounded-lg gap-2 px-4">
            <LayoutGrid className="w-4 h-4" />
            <span className="hidden sm:inline">Placement Board</span>
          </TabsTrigger>
          <TabsTrigger value="payments" className="data-[state=active]:bg-[#E8BD27]/15 data-[state=active]:text-[#E8BD27] text-white/50 rounded-lg gap-2 px-4">
        ...
        {/* HOME TAB */}
        <TabsContent value="home" className="mt-6 space-y-10 animate-in fade-in duration-300">
          ...
          <section>
            ...
            <p className="text-white/40 text-sm mb-4">
              Envie os documentos abaixo para dar continuidade ao seu processo de intercâmbio esportivo.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
